...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8 COMMENT='Tabla para almacenar los mantenimientos que se tienen disponibles';
...
INSERT INTO `actividad_mantenimiento` (`idMantenimiento`, `idHerramienta`, `idRepuesto`, `mantenimiento`, `fecha_creacion`) VALUES
	...
	(12, 'KIT 2,KIT 3,Kit 5,', 'frontal,teclado,CARCASA SS98,', 'Mantenimiento 1', '2019-11-21'),
	(13, 'KIT 1,KIT 2,KIT 3,KIT 4', 'frontal,CARCASA SS98', 'Mantenimiento 2', '2019-11-21');
...
INSERT INTO `equipos` (`idEquipo`, `equipo`, `idGrupo`, `frecuencia`, `caracteristica`, `valor`, `fecha_creacion`) VALUES
	(9, 'Equipo Dos', 13, 5, 'Peso', '8.5 KG', '2019-11-22'),
	(10, 'Equipo Dos', 13, 5, 'Color', 'GRIS', '2019-11-22'),
	(11, 'Equipo Dos', 13, 5, 'Marca', 'SONY', '2019-11-22'),
	(12, 'Equipo Dos', 13, 5, 'Voltaje', '12.5 V', '2019-11-22'),
	(13, 'Equipo Dos', 13, 5, 'Licencia', 'FREE', '2019-11-22'),
	(14, 'Equipo 3', 16, 6, 'Peso', '6.6kg', '2019-11-22'),
	(15, 'Equipo 3', 16, 6, 'Voltaje', '24.5 V', '2019-11-22');
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='Grupos de mantenimiento';
...
INSERT INTO `grupos` (`idGrupo`, `grupo`, `idCaracteristica`, `idMantenimiento`, `fecha_creacion`) VALUES
	...
	(15, 'Grupo 3', 'Peso,Color,Dimensión,Empresa,Material', 'Mantenimiento 1,Mantenimiento 2', '2019-11-21'),
	(16, 'Grupo 4', 'Peso,Voltaje', 'Mantenimiento 1', '2019-11-21'),
	(17, 'Grupo 5', 'Precio,Empresa', 'Mantenimiento 2', '2019-11-22');
